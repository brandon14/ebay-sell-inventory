...
class InventoryLocationFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets location
     *
     * @return \eBay\Sell\Inventory\Model\LocationDetails|null
     */
     ...
     * Sets location
     *
     * @param \eBay\Sell\Inventory\Model\LocationDetails|null $location location
     *
     * @return self
     */
     ...
     *
     * @param \eBay\Sell\Inventory\Model\OperatingHours[]|null $operating_hours Although not technically required, this container is highly recommended to be used to specify operating hours for a store inventory location. This container is used to express the regular operating hours for a store location during each day of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container will be needed for each day of the week that the store location is open.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone This field is used to specify the phone number for an inventory location. <br><br><b>Max length</b>: 36
     *
     * @return self
     */
     ...
     * Sets special_hours
     *
     * @param \eBay\Sell\Inventory\Model\SpecialHours[]|null $special_hours This container is used to express the special operating hours for a store inventory location on a specific date, such as a holiday. The special hours specified for the specific date will override the normal operating hours for that particular day of the week.
     *
     * @return self
     */
