...
class Regulatory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @return \eBay\Sell\Inventory\Model\EnergyEfficiencyLabel|null
     */
     ...
     *
     * @param \eBay\Sell\Inventory\Model\EnergyEfficiencyLabel|null $energy_efficiency_label energy_efficiency_label
     *
     * @return self
     */
     ...
     * Gets hazmat
     *
     * @return \eBay\Sell\Inventory\Model\Hazmat|null
     */
     ...
     * Sets hazmat
     *
     * @param \eBay\Sell\Inventory\Model\Hazmat|null $hazmat hazmat
     *
     * @return self
     */
     ...
     * Sets repair_score
     *
     * @param float|null $repair_score This field represents the repair index for the listing.<br><br>The repair index identifies the manufacturer's repair score for a product (i.e., how easy is it to repair the product.) This field is a floating point value between 0.0 (i.e., difficult to repair,) and 10.0 (i.e., easily repaired.)<br><br>The format for <b>repairScore</b> is limited to one decimal place. For example:<ul><li><code>7.9</code> and <code>0.0</code> are both valid scores</li><li><code>5.645</code> and <code>2.10</code> are both invalid scores</li></ul>
     *
     * @return self
     */
