...
class InventoryLocationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \eBay\Sell\Inventory\Model\OperatingHours[]|null $operating_hours This container shows the regular operating hours for a store location during the days of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container is shown for each day of the week that the store location is open.
     *
     * @return self
     */
