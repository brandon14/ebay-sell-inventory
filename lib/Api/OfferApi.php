...
class OfferApi
{
     ...
     *
     * @param  \eBay\Sell\Inventory\Model\BulkOffer $bulk_offer The base request of the bulkPublishOffer method. (required)
     *
     * @throws \eBay\Sell\Inventory\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \eBay\Sell\Inventory\Model\WithdrawByInventoryItemGroupRequest $withdraw_by_inventory_item_group_request The base request of the withdrawOfferByInventoryItemGroup call. (required)
     *
     * @throws \eBay\Sell\Inventory\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
