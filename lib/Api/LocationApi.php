...
class LocationApi
{
     ...
     * @param  \eBay\Sell\Inventory\Model\InventoryLocationFull $inventory_location_full Inventory Location details (required)
     *
     ...
     * @param  \eBay\Sell\Inventory\Model\InventoryLocation $inventory_location The inventory location details to be updated (other than the address and geo co-ordinates). (required)
     *
     * @throws \eBay\Sell\Inventory\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
