...
```php
bulkCreateOffer($bulk_ebay_offer_details_with_keys): \eBay\Sell\Inventory\Model\BulkOfferResponse
```
...
```php
bulkPublishOffer($bulk_offer): \eBay\Sell\Inventory\Model\BulkPublishResponse
```
...
$bulk_offer = new \eBay\Sell\Inventory\Model\BulkOffer(); // \eBay\Sell\Inventory\Model\BulkOffer | The base request of the bulkPublishOffer method.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulk_offer** | [**\eBay\Sell\Inventory\Model\BulkOffer**](../Model/BulkOffer.md)| The base request of the bulkPublishOffer method. |
...
```php
createOffer($content_language, $ebay_offer_details_with_keys): \eBay\Sell\Inventory\Model\OfferResponse
```
...
```php
getListingFees($offer_keys_with_id): \eBay\Sell\Inventory\Model\FeesSummaryResponse
```
...
```php
getOffers($sku, $marketplace_id, $format, $limit, $offset): \eBay\Sell\Inventory\Model\Offers
```
...
```php
publishOfferByInventoryItemGroup($publish_by_inventory_item_group_request): \eBay\Sell\Inventory\Model\PublishResponse
```
...
```php
updateOffer($offer_id, $content_language, $ebay_offer_details_with_id): \eBay\Sell\Inventory\Model\OfferResponse
```
...
$withdraw_by_inventory_item_group_request = new \eBay\Sell\Inventory\Model\WithdrawByInventoryItemGroupRequest(); // \eBay\Sell\Inventory\Model\WithdrawByInventoryItemGroupRequest | The base request of the withdrawOfferByInventoryItemGroup call.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **withdraw_by_inventory_item_group_request** | [**\eBay\Sell\Inventory\Model\WithdrawByInventoryItemGroupRequest**](../Model/WithdrawByInventoryItemGroupRequest.md)| The base request of the withdrawOfferByInventoryItemGroup call. |
