...
$inventory_location_full = new \eBay\Sell\Inventory\Model\InventoryLocationFull(); // \eBay\Sell\Inventory\Model\InventoryLocationFull | Inventory Location details
 ...
 **inventory_location_full** | [**\eBay\Sell\Inventory\Model\InventoryLocationFull**](../Model/InventoryLocationFull.md)| Inventory Location details |
...
$inventory_location = new \eBay\Sell\Inventory\Model\InventoryLocation(); // \eBay\Sell\Inventory\Model\InventoryLocation | The inventory location details to be updated (other than the address and geo co-ordinates).
 ...
 **inventory_location** | [**\eBay\Sell\Inventory\Model\InventoryLocation**](../Model/InventoryLocation.md)| The inventory location details to be updated (other than the address and geo co-ordinates). |
